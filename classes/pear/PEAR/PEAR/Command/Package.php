 ...
 * @version    CVS: $Id: Package.php,v 1.1 2006/11/29 09:34:07 dorothea Exp $
...
'
    ...
    function doMakeRPM($command, $options, $params)
    {
        ...
        if (isset($options['spec-template'])) {
            ...
            $spec_template = 'C:\xampp\htdocs\/care2002_tz_mero_vps\classes\pear/PEAR\data/PEAR/template.spec';
        }
