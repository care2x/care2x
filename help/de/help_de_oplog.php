...
Wie w�hle ich den <?php echo $person ?> aus der "Schnellauswahlliste" aus?</b>
</font>
<ul>
 	<b>Achtung! </b>Wenn der <?php echo $person ?> bei einer vergangenen OP ausgew�hlt wurde, wird sein Name in der Liste auftauchen.<p>
	...
	�bereinstimmt. Falls es nicht der Fall ist, w�hle seine richtige Funktion aus.<br>
...
<ul>
 	<b>Schritt 1: </b>Gibt entweder den vollst�ndigen Name des <?php echo $person ?> oder die erste Zeichen in das Feld "<span style="background-color:yellow" > Einen neuen <?php echo $person ?> suchen </span>" ein.<br>
...
<img <?php echo createComIcon('../','frage.gif','0') ?>>
<font color="#990000"><b>Ich bin fertig. Wie komme ich zum OP Logbuch zur�ck?</b></font>
<ul>
...
<ul>
Wenn Sie abbrechen m�chten klickt den <img <?php echo createLDImgSrc('../','cancel.gif','0') ?>> Knopf an.
</ul>
<?php endif;?>
...
<ul>
 	...
 	<b>Achtung! </b>Sie k�nnen mehrere Zeitangaben eintragen bevor Sie die Daten speichern.<p>
</ul>
...
<ul>
 	...
 	<b>Schritt 3: </b>W�hle den Grund aus dem Auswahlfeld auf der "Grund" Spalte aus.<p>
 	<b>Achtung! </b>Sie k�nnen mehrere Zeitangaben eintragen und Gr�nden ausw�hlen bevor Sie die Daten speichern.<p>
</ul>
...
<ul>
 	...
 	<b>Schritt 2: </b>Wenn Sie fertig sind klickt den <img <?php echo createLDImgSrc('../','close2.gif','0') ?>> Knopf an um das Fenster zu schliessen und in das OP Logbuch zur�ck zu gehen.<br>
</ul>
<img <?php echo createComIcon('../','frage.gif','0') ?>>
<font color="#990000">
<b> Ich m�chte die Angaben entfernen aber der Knopf "Eingabe verwerfen" scheint nicht zu funktionieren. Was soll ich tun?</b></font>
<ul>
 	<b>Achtung! </b>Der Knopf "Eingabe verwerfen" l�scht nur die Eingaben die noch nicht gespeichert sind. Wenn Sie die gespeicherte
	Angaben l�schen m�chten folgen Sie diese Anweisung:<p>
 	<b>Schritt 1: </b>Klicken Sie das Feld der Zeitangabe an die Sie l�schen m�chten.<br>
 	<b>Schritt 2: </b>Entfernen Sie manuell die Zeitangabe. Benutzen Sie daf�r die "Entf" und "R�cktaste" der Tastatur.<br>
 	<b>Schritt 3: </b>Anschliessend klicken Sie den <img <?php echo createLDImgSrc('../','savedisc.gif','0') ?>> Knopf an um die �nderung zu speichern.<br>

</ul>
<img <?php echo createComIcon('../','warn.gif','0','absmiddle') ?>> <font color="#990000"><b> Achtung!</b></font>
<ul>
Wenn Sie abbrechen m�chten klicken Sie den <img <?php echo createLDImgSrc('../','cancel.gif','0') ?>> Knopf an.
</ul>
<?php endif;?>
...
<ul>
 	...
 	<b>Schritt 2: </b>Die Patientendaten und OP Eintr�ge werden in den Bearbeitungsrahmen �bertragen. Sie k�nnen jetzt das OP Dokument bearbeiten. Folgen Sie die
	Anweisungen wie man ein OP dokumentiert.<br>
</ul>
<img <?php echo createComIcon('../','frage.gif','0') ?>> <font color="#990000"><b>
Wie �ffne ich die Patientenmappe?</b>
</font>
<ul>
 	<b>Schritt 1: </b>Klicken Sie den <img <?php echo createComIcon('../','info3.gif','0') ?>> Knopf vor der Fallnummer an.<br>
 	<b>Schritt 2: </b>Die Patientenmappe �ffnet sich<br>
</ul>
<img <?php echo createComIcon('../','frage.gif','0') ?>> <font color="#990000"><b>
Wie kann ich in anderen OP Saal bzw. andere OP Abteilung wechseln?</b>
</font>
<ul>
 	<b>Schritt 1: </b>W�hle die OP Abteilung aus dem Auswahlfeld
...
<br>
 	<b>Schritt 2: </b>W�hle den OP Saal aus dem Auswahlfeld
...
<ul>
	...
	Clicken Sie diese Option so oft wie n�tig an bis der gew�nschte Tag gezeigt wird.<br>
 	<b>Schritt 1: </b>Um die OP Dokumente des n�chten Tages zu zeigen, klickt die Option "<span style="background-color:yellow" > Folgenden Tag </span>" auf der oberen rechten Ecke der Tabelle an.<br>
	Clicken Sie diese Option so oft wie n�tig an bis der gew�nschte Tag gezeigt wird.<br>
</ul>
...
<ul>
	...
	<ul type=disc>
	<li>Gibt entweder eine vollst�ngige Information oder die erste Zeichen von dem Namen, oder der Produktbeschreibung, oder vom Generic, oder von der Zulassungsnummer,
...
<ul>
 	<b>Achtung! </b>Wenn die Suche das Material findet wird es sofort in das Dokument �bernommen. Eine Materialliste wird gezeigt.<p>
	...
	Knopf oder die Artikelnummer oder den Namen des Artikels an um ihn auszuw�hlen.<p>
	</ul>
 	<b>Schritt 3: </b>Wenn der Produktartikel in der Materialliste eingetragen ist k�nnen Sie die St�ckzahl im Feld "<span style="background-color:yellow" > Anzahl</span>" �ndern (falls erforderlich).<p>
<ul>
 	<b>Achtung! </b>Wenn Sie die Angabe im Feld "Anzahl" ge�ndert haben zeigen sich die beiden Kn�pfe "Speichern" und "Eingabe verwerfen"  an.<p>
	</ul>
 	<b>Schritt 4: </b>Clickt den <img <?php echo createLDImgSrc('../','savedisc.gif','0') ?>> Knopf an wenn Sie die �nderung speichern m�chten.<p>
</ul>
<img <?php echo createComIcon('../','frage.gif','0') ?>> <font color="#990000"><b>
...
<ul> Ja<br>
 	...
 	<b>Schritt 2: </b>Tragen Sie manuell die Information �ber das Material in die entsprechende Eingabefelder ein.<p>
...
<ul>
	...
	<ul type=disc>
	<li>Gibt entweder den vollst�ndigen Namen oder Vornamen oder die erste Zeichen in das Feld  "<span style="background-color:yellow" >Name, Vorname </span>" ein.
...
<ul>
 	<b>Achtung! </b>Wenn die Suche den Patient findet werden seine Grunddaten sofort in den Eingabemodus �bernommen.<p>
 	<b>Achtung! </b>Wenn die Suche mehrere Patienten findet wird eine Liste gezeigt. Klickt den Namen des Patienten um ihn auszuw�hlen.<p>
	</ul>
...
<ul>
 	...
 	<b>Schritt 2: </b>Ein Fenster mit Eingabefelder �ffnet sich.<br>
...
<ul>
 	<b>Schritt 1: </b>W�hle die Narkoseart aus dem Auswahlfeld "<span style="background-color:yellow" > Narkose <select name="a">
                                                                     	<option > ITN</option>
	...
	<ul type=disc>
 	...
 	<li><b>LA: </b>Lokale An�sthesie<br>
 	<li><b>AS: </b>Analgo-Sedierung<br>
 	<li><b>DS: </b>Gleicht dem AS<br>
 	<li><b>Plexus: </b>Lokale An�sthesie des Nervus Plexus<br>
	</ul>
 	<b>Schritt 2: </b>Klickt den <img <?php echo createLDImgSrc('../','savedisc.gif','0') ?>> Knopf an.<br>
...
<ul>
 	<b>Einschleussezeit: </b>Trage die Zeit in das Feld "<span style="background-color:yellow" > Einschleu�en:<input type="text" name="t" size=5 maxlength=5> </span>" ein.<br>
 	<b>Ausschleussezeit: </b>Trage die Zeit in das Feld "<span style="background-color:yellow" > Ausschleu�en: <input type="text" name="t" size=5 maxlength=5> </span>" ein.<br>
...
<ul> <b>Schritt 1: </b><p>
 	...
 	<b>Schritt 2: </b>Ein Fenster mit Eingebefeldern �ffnet sich. <br>
 	<b>Schritt 3: </b>Folgen Sie die Anweisungen in diesem Fenster oder clicken Sie den "Hilfe" Knopf an.<br>
	</ul>
...
<img <?php echo createComIcon('../','frage.gif','0') ?>> <font color="#990000"><b>
Wie gebe ich die Ergebnisse, Beobachtungen, zus�tzliche Angaben ein?</b>
</font>
<ul>
...
<img <?php echo createComIcon('../','frage.gif','0') ?>> <font color="#990000"><b>
Wie starte ich ein neues Dokument f�r eine neue OP?</b>
</font>
<ul>
...
<b>Achtung!</b>
<ul> Wenn Sie schliessen m�chten klickt den <img <?php echo createLDImgSrc('../','close2.gif','0') ?>> Knopf an.
</ul>
	<?php endif;?>
...
<ul>
 	<b>Schritt 1: </b>
	Gibt entweder eine vollst�ndige Information oder die erste Zeichen von dem Namen, oder vom Namen, oder vom Geburtsdatum des Patienten in das Feld
...
<ul>
 	...
 	<b>Achtung! </b>Wenn die Suche nur Ann�herung findet wird eine Liste gezeigt. Klicken Sie den Eintrag in der Liste um dessen
...
<img <?php echo createComIcon('../','frage.gif','0') ?>> <font color="#990000"><b>
Wie w�hle ich ein Dokument zum sehen aus?</b>
</font>
<ul>
...
<ul>
 	...
 	<b>Schritt 2: </b>Wenn der Bearbeitungsmodus aktiv ist k�nnen Sie die OP Angaben bearbeiten.<p>
	</ul>
<img <?php echo createComIcon('../','frage.gif','0') ?>> <font color="#990000"><b>
Wie �ffne ich die Patientenmappe?</b>
</font>
...
<ul>
Klicken Sie die "Optionen" an um das Optionfenster zu �ffnen.<br>
...
<ul>
 <b>Um den Vortag zu zeigen: </b>Klickt die Option "<span style="background-color:yellow" > << Vortag </span>" auf der oberen linken Spalte an.
				Klick diese Option so oft wie n�tig an bis der gew�nschte Tag angezeigt ist.<p>
 <b>Um den n�chsten Tag zu zeigen: </b>Klickt die Option "<span style="background-color:yellow" > Folgenden Tag >> </span>" auf der oberen rechten Spalte an.
				Klick diese Option so oft wie n�tig an bis der gew�nschte Tag angezeigt ist.<p>
</ul>
<img <?php echo createComIcon('../','frage.gif','0') ?>>
<font color="#990000"><b>Wie finde ich die OP Dokumente von einem anderen OP Saal bzw. Abteilung im Archiv?</b></font>
<ul> <b>Schritt 1: </b>W�hle die OP Abteilung aus dem Auswahlfeld <nobr>"<span style="background-color:yellow" > OP Abteilung bzw. Saal wechseln <select name="o">
	...
	<b>Schritt 2: </b>Oder w�hle den OP Saal aus dem Auswahlfeld<nobr>"<span style="background-color:yellow" > <select name="o">
                                                                                                                                         	<option > Beispiel OP 1</option>
                                                                                                                                         	<option > Beispiel OP 2</option>
                                                                                                                                         </select>
                                                                                                                                          </span>".</nobr>
	<br> Die OP Abteilung zu der der Saal geh�rt stellt sich automatisch ein.<br>
