...
if($src=="create")
{
	...
	case "get": print  "";
						break;
	case "logmain": print "Editar un registro de un documento de cirug�a";
						break;
	default: print "Registrar una nueva operaci�n";	
	}
}
if($src=="time")
{
	...
	case "bandage_time": print "Tiempo de vendaje";
						break;
	case "repos_time": print "Tiempo de reposici�n";
	}
}
if($src=="person")
{
	...
	case "rotating":$person="una Enfermera rotante"; 
						break;
	case "ana": $person="un Anestesi�logo";
	}
	print $person;
}
if($src=="search")
{
	...
	case "search": print "Seleccionando un documento en particular ";
						break;
	case "": print "Buscar un documento de registro de cirug�a";
						break;
	case "get": print  "Documento de registro del Paciente de cirug�a ";
						break;
	case "fresh": print "Buscar un documento de registro de cirug�a";
	}
}
if($src=="arch")
{
...
<form action="#" >
  ...
  <ul>
    ...
    <p> <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Paso 1: 
      ...
      ser� autom�ticamente agregado a la lista actual. </font>
    <p> 
  </ul>
  <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><img <?php echo createComIcon('../','frage.gif','0') ?>> 
  <font color="#990000"><b> <?php echo ucfirst($person) ?> No aparece en la lista 
  de vista r�pida, �Como agregar <?php echo $person ?>?</b> </font></font> 
  <ul>
    <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Paso 1: </b>Escriba 
    ya sea la informaci�n completa o las primeras letras del apellido,o nombbre 
  ...
  <?php if($x1=="entry_out") : ?>
  <img <?php echo createComIcon('../','frage.gif','0') ?>> <font color="#990000"><b> 
  �Como ducumentar la hora de entrada y salida a Quir�fano?</b> </font></font> 
  <ul>
    <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Paso 1: </b>Escriba 
  ...
  "Borrar datos" pero no trabaja. �Que deber�a hacer?</b></font></font> 
  <ul>
  ...
  <?php if($x1=="logmain") : ?>
  <img <?php echo createComIcon('../','frage.gif','0') ?>> <font color="#990000"><b> 
  �Como editar una entrada de registro de operaci�n?</b> </font></font> 
  <ul>
    <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Paso 1: </b>D� 
    clic en el bot�n <img src="../img/update3.gif" width=15 height=14 border=0> 
    correspondiente a la entrada de registro del paciente.<br>
    <b>Paso 2: </b>La entrada de registro del paciente ser� copiada al marco de 
    edici�n. Ahora podr� editarla siguiendo las instrucciones para documentar 
    una operaci�n. <br>
    </font> 
  </ul>
  <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><img <?php echo createComIcon('../','frage.gif','0') ?>> 
...
foreach($Or2Dept as $x=>$v)
  ...
  <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><img <?php echo createComIcon('../','frage.gif','0') ?>> 
  <font color="#990000"><b> &iquest;Como quitar un art�culo de la lista?</b> </font></font> 
  <ul>
    <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Paso 1: </b>D� 
    clic al icono <img <?php echo createComIcon('../','delete2.gif','0','absmiddle') ?>> 
  ...
  <?php if(($x1=="")||($x1=="fresh")) : ?>
  <img <?php echo createComIcon('../','frage.gif','0') ?>> <font color="#990000"><b> 
  &iquest;C�mo empezar un documento de registro para una operaci&oacute;n?</b> 
  </font></font> 
  <ul>
  ...
  <ul>
    ...
    <p> <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Tiempo 
      de espera: </b> D� clic al enlace ""<span style="background-color:yellow" > 
      tiempo de espera<img <?php echo createComIcon('../','bul_arrowgrnsm.gif','0','absmiddle') ?>> 
      </span>" situada en la esquina inferior izquierda. </font> 
    <p> <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Tiempo 
      de Enyesamiento/Vendajes:</b> D� clic al enlace "<span style="background-color:yellow" > 
  ...
  <ul>
    <font size="2"> Si usted decide cerrar d� clic al bot�n <img <?php echo createLDImgSrc('../','close2.gif','0') ?>>. 
    </font> 
  </ul>
  <font size="2">
  <?php endif;?>
  ...
  <ul>
    <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Paso 1: </b>Escriba 
    ya sea la informaci�n completa o la primeras letras del nombre o apellido 
    ...
    <p><font size="2"><b>Nota: </b>Si la b�squeda encontr� un resultado la informaci�n 
      b&aacute;sica del paciente ser� agregada inmediatamente en los campos correspondientes.. 
      </font></font> 
    <p> <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Nota: </b>Si 
      la b�squeda encuentra varios resultados, aparecer� un listado. Haga clic 
  ...
  <ul>
    ...
    <select name="o">
      <option > Quir�fano 1</option>
      <option > Quir�fano 2</option>
    </select>
    </span>".</nobr> <br>
    Se ajustar&aacute; autom&aacute;ticamente.<br>
    <b>Paso 3: </b>D� clic en el bot�n 
