...
if($src=="time")
{
	...
	case "cut_close": print "tempi di taglio e sutura";
						break;
	case "wait_time": print "tempi di inattivit� (attesa)";
						break;
...
<ul>       	
 	<b>Nota: </b>Se si � gi� scelto <?php $person ?>, il nome apparir� nella lista di selezione rapida.<p>
 	<b>1: </b>Controllare se la funzione nel riquadro" Funzioni di sala op. " � correttamente impostata:
	...
	Il chirurgo sar� automaticamente aggiunto alla lista delle "voci correnti".<p>
</ul>
<img <?php echo createComIcon('../','frage.gif','0') ?>> <font color="#990000"><b>
<?php ucfirst($person) ?> non � nella lista di selezione rapida: come faccio a inserirla?</b>
</font>
<ul>       	
...
<ul>       	
 	<b>1: </b>Premere il bottone <img <?php echo createLDImgSrc('../','close2.gif','0') ?> align="absmiddle"> che apparir� dopo aver scelto <?php $person ?>.<br>
...
<ul>       	
 	...
 	<b>Nota: </b>E' possibile inserire pi� di un tempo di ingresso ed uscita prima di salvare.<p>
</ul>
	<?php } ?>
	<?php if($x1=="cut_close") { ?>
<img <?php echo createComIcon('../','frage.gif','0') ?>> <font color="#990000"><b>
...
<ul>       	
 	...
 	<b>Nota: </b>E' possibile inserire pi� tempi di taglio e sutura prima di salvare.<p>
</ul>

	<?php } ?>
	<?php if($x1=="wait_time") { ?>
<img <?php echo createComIcon('../','frage.gif','0') ?>> <font color="#990000"><b>
Come fare a registrare tempi di inattivit� (attesa)?</b>
</font>
<ul>       	
...
<ul>       	
 	...
 	<b>Nota: </b>E' possibile inserire pi� tempi iniziali/finali e motivazioni prima di salvare.<p>
</ul>
	<?php } ?>
...
<ul>       	
 	...
 	<b>Nota: </b>E' possibile inserire pi� tempi iniziali e finali prima di salvare.<p>
</ul>
	<?php } ?>
...
<ul>       	
	...
	gi� salvate, seguire queste istruzioni:<p>
...
<ul>       	
 	...
 	<b>2: </b>Apparir� la cartella dei dati paziente.<br>
</ul>
<img <?php echo createComIcon('../','frage.gif','0') ?>> <font color="#990000"><b>
...
<ul>       	
 	...
 	<b>Nota: </b>Se invece ci sono pi� risultati, apparir� un elenco. Premere il bottone <img <?php echo createComIcon('../','bul_arrowgrnlrg.gif','0') ?>> il codice articolo, o il nome per aggiungerlo al documento.<p> 
	</ul>
 	<b>3: </b>Se necessario, � possibile modificare il campo "<span style="background-color:yellow" > pezzi </span>" per l'articolo.<p> 
<ul>       	
...
<img <?php echo createComIcon('../','frage.gif','0') ?>> <font color="#990000"><b>
L'articolo non � presente. E' possibile inserirlo manualmente?</b>
</font>
<ul> 
...
<ul>       	
 	...
 	<b>Nota: </b>Se invece ci sono pi� risultati, apparir� un elenco. Selezionare il cognome o il nome del paziente desiderato.<p> 
	</ul>
...
<ul>       	
 	...
 	<b>2: </b>Apparir� una finestrella con le informazioni richieste.<br>
...
<ul>       	
 	...
 	<b>Nota: </b>Se la ricerca identifica pi� risultati, apparir� un elenco. 
...
<ul>       	
 	<b>1: </b>Selezionare <img src="../img/update3.gif" border=0> posto sotto la data dell'operazione nella colonna pi� a sinistra per passare al modo modifica.<br>
...
<ul>       	
 	...
 	<b>2: </b>Apparir� la cartella dei dati paziente. Selezionare il tasto "Aiuto" nella finestra per altre istruzioni.<p> 
	</ul>
...
<ul> <b>1: </b>Scegliere il dipartimento nel riquadro di selezione <nobr>"<span style="background-color:yellow" > Cambia sala op. o dipartimento <select name="o">
	...
	sar� aggiornata automaticamente.<br>																																		  
	...
	sar� aggiornato automaticamente.<br>																																		  																																		  
