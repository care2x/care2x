...
CREATE TABLE IF NOT EXISTS `care_med_orderlist_sub` (
  ...
  `idsub` varchar(20) NOT NULL DEFAULT '0' COMMENT 'id of care_pharma_products_main_sub',
...
CREATE TABLE IF NOT EXISTS `care_med_products_main_sub` (
  ...
  `bestellnum` varchar(25) DEFAULT NULL COMMENT 'connection to care_med_products_main',
...
CREATE TABLE IF NOT EXISTS `care_pharma_products_main_sub` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `bestellnum` varchar(25) DEFAULT NULL COMMENT 'connection to care_pharma_products_main',
  `pcs` double NOT NULL DEFAULT '0',
  `expiry_date` date DEFAULT NULL,
  `price` double DEFAULT NULL,
...
INSERT INTO care_department VALUES (40, 'general_ambulant', '1', 'General Outpatient Clinic', 'General Clinic', 'General Ambulatory Clinic', 'LDGeneralOutpatientClinic', 'Outpatient/Ambulant Clinic for general/internal medicine', '0', '1', '1', '1', '0', '1', '0', '0', 'round the clock', '8:30 AM - 11:30 AM , 2:00 PM - 5:30 PM', '0', '0', '', '', '', '', '', '', '', 00000000000000, '', 00000000000000, '','');
...
INSERT INTO care_unit_measurement VALUES (18, 1, 'μl', 'microliter', 'LDMicroliter', 'metric', 0, '', '', 00000000000000, '', 00000000000000);
