...
* Revisión Dr. JR. BioLinux. Agosto, 2004.
*/
...
*/
$LDDOC='Cirujano de llamada/guardia';
$LDORNOC='Enfermera de guardia en quirófanos';
$LDScheduler='Organizador de itinerario';

$LDQuickView='Vista rápida';
$LDQviewTxtDocs='Vista rápida del cirujano de llamada';
...
$LDQviewTxtNurse='Vista rápida de las actividades en standby de enfermería de hoy';
$LDDutyPlanTxt='Mostrar, editar, crear actividades para la enfermera de guardia en quirófanos';
$LDOnCallDuty='Actividades en standby';
$LDOnCallDutyTxt='Documentando el trabajo durante una actividad de guardia';
$LDAnaLogBook='Bitácora de anestesia';
$LDAnaLogBookTxt='Documentando los servicios de anestesia, documentos de archivo';
$LDQviewTxtAna='Vista rápida de las actividades de la enfermera de guardia en quirófanos para anestesia';
...
$LDClk2Show='Haga clic para mostrar';
...
$LDDate='Fecha';
$LDClk2DropMenu='Haga clic para desplegar el menú';
...
$LDStart='Inicio';
$LDEnd='Finalización';
$LDPatNoExist='El paciente no ha ingresado aún a la bitácora. Por favor, cierre esta ventana e inicie la bitácora desde el principio. Si este problema persiste, por favor notifique al Departamento o Area de Sistemas.';
$opts=array('-',
...
$LDPlsClkArticle='¡Por favor, haga clic en el artículo deseado!';
$LDSelectArticle='Haga clic para seleccionar este artículo';
...
$LDPrint='Imprimir';
$LDAlertNoPrinter='Debe imprimirlo manualmente.  Haga clic con el botón derecho sobre la ventana, luego seleccione "Imprimir".';
