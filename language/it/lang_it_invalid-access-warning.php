...
si � fatto uso dei tasti "Avanti" e "Indietro" del browser: bisognerebbe evitare di usarli.<br>
<img <?php echo createComIcon('../../','achtung.gif') ?>>
il browser ha rifiutato un cookie. Configurare il browser in modo da accettarli, perch� l'applicativo
nel fa uso.
<br>
<img <?php echo createComIcon('../../','achtung.gif') ?>>
il browser potrebbe non essere in grado di eseguire javascript, oppure i javascript potrebbero essere
disattivati. Dato che l'applicativo li usa, � necessario attivarli.
<br>
<img <?php echo createComIcon('../../','achtung.gif') ?>>
In alcuni rari casi, possono esserci stati degli errori di trasferimento dati: in questo caso � 
