	...
	<body onLoad="if(window.focus) window.focus()">	
		...
		<table cellspacing=0 cellpadding=0 border=0	width=100%>	
		  <tbody> 
			<tr> 
			  <td valign=top><font face="verdana,arial"	size=2>	
				<p><img	src="../../uploads/photos/credits/gabriele_cicala.jpg"  border=0	 align=right vspace=10>	<b>Gabriele	Cicala (IT)	je preveo većinu www.care2x.com websajta na  italijanski.</b> 
