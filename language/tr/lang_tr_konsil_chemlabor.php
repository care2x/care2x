<?php
$LDDiagnosticTest='Tetkik �stemi';
$LDHospitalName='Care2x Hastanesi';
$LDCentralLab='Merkez Laboratuvar�';
$LDLabel='Etiket';
$LDRoomNr='Oda no.';
$LDSamplingTime='�rnek alma zaman�';
$LDDay='G�n';
$LDMinutes='Dakika';
$LDHours='Saat';
$LDBatchNr='K�me No.';
...
$LD15Hour='15.00';
$LDSober='ay�k';
$LDBloodSugar='Kan �ekeri';
$LDBLoodSugar1='K�1';
$LDBloodPlasma='Plazma';
$LDDoctorSignature='Doktorun imzas�';
$LDLifeRisk='Ya�am riski';
$LDRarity='yetersiz';
$LDSpecTest='�zel tetkikler';
...
$LDShortDay=array('Pz','Pt','Sa','�a','Pe','Cu','Ct','Pz');

$LDBatchNumber='K�me no.';
$LDMaterial='Materyel:';
$LDEmergencyProgram='Mor g�lgeli alanlar acil program�na aittir';
...
$LD_Elements = array('tx_1'=>'Biyokimya',
								  ...
								  '_emx_urin_status_' => '�drar g�r�n�m�',
								  ...
								  '_emx_urin_amilase_'=>'�drar amilaz�',
								  ...
								  '_emx_osmol_in_urine_'=>'Osmol �drarda',
								  ...
								  '_cytomegaly_in_urine_'=>'Sitomeg. �drarda',
								  ...
								  '_lithium_'=>'Lithium',
								  '_urine_cytology_'=>'�drar sitolojisi',

								  '_gamma_gt_'=>'gamma GT',
								  '_emx_thrombos_coagulation_'=>'P�ht�la�ma',
								  '_ferritin_'=>'Ferritin',
								  '_scc_'=>'SCC',
								  ...
								  '_urine_elpho_'=>'�drar elektroforezi',
								  ...
								  '_primidon_'=>'Primidon',
								  '_beta_2_microglobulin_in_urine_'=>'�drarda �2 Mikroglob.',
								  ...
								  '_ssw_'=>'Gebelik',
								  '_ama_'=>'AMA',
								  '_q_fever_antibody_'=>'Q-Ate�i-Antikoru',
								  '_theophyllin_'=>'Teofilin',
								  '_urine_collected_'=>'Toplanm��-',

								  '_emx_ckmb_'=>'CKMB',
								  '_protein_s_telx_'=>'Protein S',
								  '_alpha_1_microglobulin_'=>'alfa-1 �globulin',
								  ...
								  '_sodium_in_urine_'=>'Sodyum �drarda',
								  ...
								  '_gldh_'=>'GLDH',
								  '_diff_minor_blood_test_'=>'Tam kan.+ min�r.Kan Testi',
								  '_tsh_basal_'=>'TSH-basal',
								  'tx_13'=>'Romatizma fakt�rleri',
								  '_fsme_antibody__x__fsme_antibody_2_'=>'FSME-Antikoru',
								  '_emx_drugscreen_in_urine_'=>'�drarda ila� tarama',
								  '_calcium_in_urine_'=>'Kalsiyum �drarda',

								  '_chol_'=>'Kolestrol',
								  '_reticulocytes_'=>'Retik�losit',
								  '_tsh_stimulation_'=>'TSH-stim�lasyon.',
								  '_anti_strepto_titer_'=>'Anti-Strepto-Titresi',
								  '_herpes_simplex_1_antibody_'=>'Herpes sim.1-Antikor',
								  '_amphetamine_in_urine_'=>'Amfetamin �drarda',
								  '_phospor_in_urine_'=>'Fosfor �drarda',

								  '_tri_'=>'Tri',
								  '_kemik _ili�i_diff_telx_'=>'K.ili�i+Ayr�nt�l�.',
								  '_tak_'=>'TAK',
								  '_lat_rf_'=>'Lat.RF',
								  '_herpes_simplex_2_antibody_'=>'Herpes sim.2-Antikor',
								  '_antidepressant_in_urine_'=>'Antidepresan �drarda',
								  '_uric_acid_in_urine_'=>'�rik asit idrarda ',
								  ...
								  '_barbiturates_in_urine_'=>' Barbit�rat.',
								  ...
								  '_benzodiazepam_in_urine_'=>'Benzodiazep.�drarda',
								  '_porphyrine_in_urine_'=>'Porfirin �drarda',
								  ...
								  '_cannabinol_in_urine_'=>'Kannabinol �drarda',
								  '_cortisol_in_urine_'=>'Kortizol �drarda',

								  '_lipase_'=>'Lipaz',
								  '_thrombo_antibody_telx_'=>'Trombo-Antikor',
								  '_thyroxinbinding_globulin_'=>'Tiroksin ba�lay�c� Glob.',
								  '_anti_hav_'=>'Anti-HAV',
								  '_lcm_antibody_'=>'LCM-Antikor',
								  '_cocain_in_urine_'=>'Kokain �drarda',
								  '_vms_in_urine_'=>'VMS �drarda',
								 ...
								 '_methadon_in_urine_'=>'Methadon �drarda',
								 '_5_hies_in_urine_'=>'5.-Uyu�turucu �drarda',
								 ...
								 '_opiates_in_urine_'=>'Opiyatlar �drarda',
								 '_hydroxyprolin_in_urine_'=>'Hidroksiprolin �drarda',

								 '_uric_acid_'=>'�rik asit',
								 '_emx_bloodsugar_sober_'=>'A�l�k kan �ekeri',
								 '_aldosteron_'=>'Aldosteron',
								 '_anti_hbs_titer_'=>'Anti-HBs-Titre',
								 '_listeria_antibody_'=>'Listeria-Antikor',
								 'tx_17'=>'Prenatal',
								 '_cathecholamines_in_urine_'=>'Katekolamin �drarda',
								 ...
								 '_cortisol_'=>'Kortizol',
								 '_anti_hbe_'=>'Anti-HBe',
								 '_mononucleosis_'=>'Monon�kleoz',
								 '_first_serology_'=>'1.nci seroloji',
								 '_aminolevulin_in_urine_'=>'Aminol�vulin �drarda',

								 '_emx_kalium_'=>'Potassium',
								 '_emx_bloodsugar_15_00_'=>'Glukoz 15.00',
								 '_cortisol_day_program_'=>'Kortizol g�nprog.',
								 '_anti_hbc_'=>'Anti_HBc',
								 ...
								 '_emx_bloodsugar_notime_'=>'Glukoz.zamans�z',
								 '_fsh_'=>'FSH',
								 ...
								 '_chloride_'=>'Klor',
								 '_emx_bloodsugar_notime_2_'=>'Glukoze.zamans�z',
								 '_gastrin_'=>'Gastrin',
								 '_anti_hcv_'=>'Anti_HCV',
								 ...
								 '_emx_infant_bilirubin_'=>'Bebek bilir�bini',
								 ...
								 'tx_23'=>'BOS',
								 '_emx_infant_bilirubin_direct_'=>'Bilir�bin direk',
								 '_prolactin_1_'=>'Prolaktin 1',
								 '_uric_material_in_punctat_'=>'�rik bade biopside',
								 '_infection_tpha__x__infection_tpha_2_'=>'TPHA',
								 '_rarity_h_'=>'yetersiz H',
								 '_g4_'=>'G4',

								 '_emx_liquor_status_'=>'Bos g�r�n�m�',
								 ...
								 'blankline'=>'',
								 '_e1_'=>'E1',
								 '_urine_rarity_'=>'�drar yetersiz',
								 '_g7_'=>'G7',

								 '_oligoklonal_igg_'=>'Oligoklona.IgG',
								 '_infant_diff_minor_blood_test_'=>'Ayr�nt.+min.KT',
								 ...
								 '_reiber_schema_'=>'Reiber-�emas�',
								 '_infant_reticulocytes_'=>'Retik�lositler',
								 ...
								 'tx_24'=>'Doktorun imzas�',
								 'tx_25'=>'Y�ksek risk >>',
								 '_highrisk_'=>'<< Y�ksek  risk',
								 'tx_26'=>'yetersizlik:',
								 'tx_27'=>'�zel Test',
								 'tx_28'=>'',
								 'tx_29'=>'klinik bilgi',
