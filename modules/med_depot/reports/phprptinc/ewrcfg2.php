...
define("EW_REPORT_RANDOM_KEY", '3T&ULF#94#PXOLR_', TRUE); // Random key for encryption
...
define("EW_REPORT_PROJECT_NAME", "depo", TRUE); // Project Name
define("EW_REPORT_PROJECT_VAR", "depo", TRUE); // Project Name
