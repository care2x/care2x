...
define("EW_REPORT_TABLE_VAR", "Skadenca", TRUE);
define("EW_REPORT_TABLE_GROUP_PER_PAGE", "grpperpage", TRUE);
define("EW_REPORT_TABLE_SESSION_GROUP_PER_PAGE", "Skadenca_grpperpage", TRUE);
define("EW_REPORT_TABLE_START_GROUP", "start", TRUE);
define("EW_REPORT_TABLE_SESSION_START_GROUP", "Skadenca_start", TRUE);
define("EW_REPORT_TABLE_SESSION_SEARCH", "Skadenca_search", TRUE);
define("EW_REPORT_TABLE_CHILD_USER_ID", "childuserid", TRUE);
define("EW_REPORT_TABLE_SESSION_CHILD_USER_ID", "Skadenca_childuserid", TRUE);
...
$EW_REPORT_TABLE_SQL_SELECT = "SELECT care_pharma_products_main_sub.bestellnum, care_pharma_products_main.artikelname, care_pharma_products_main.packing, care_pharma_products_main.dose, care_pharma_products_main_sub.pcs, care_pharma_products_main_sub.price, (care_pharma_products_main_sub.pcs * care_pharma_products_main_sub.price ) AS value, care_pharma_products_main_sub.expiry_date FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_TABLE_SQL_WHERE = "care_pharma_products_main_sub.expiry_date < NOW()";
...
Skadenca
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="skadencarpt.php?export=html">Per printim</a>
&nbsp;&nbsp;<a href="skadencarpt.php?export=excel">Eksporto ne Excel</a>
&nbsp;&nbsp;<a href="skadencarpt.php?export=word">Eksporto ne Word</a>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
</div></td></tr>
...
<br />
<?php if (@$sExport == "") { ?>
<form action="skadencarpt.php" name="ewpagerform" id="ewpagerform">
...
<!--first page button-->
	...
	<?php } else { ?>
	<td><a href="skadencarpt.php?start=1"><img src="phprptimages/first.gif" alt="Pare" width="16" height="16" border="0"></a></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($PrevStart == $nStartGrp) { ?>
	<td><img src="phprptimages/prevdisab.gif" alt="Paraardhes" width="16" height="16" border="0"></td>
	<?php } else { ?>
	<td><a href="skadencarpt.php?start=<?php echo $PrevStart; ?>"><img src="phprptimages/prev.gif" alt="Paraardhes" width="16" height="16" border="0"></a></td>
	<?php } ?>
<!--current page number-->
...
<!--next page button-->
	...
	<?php } else { ?>
	<td><a href="skadencarpt.php?start=<?php echo $NextStart; ?>"><img src="phprptimages/next.gif" alt="Pasardhes" width="16" height="16" border="0"></a></td>
	<?php  } ?>
<!--last page button-->
	<?php if ($LastStart == $nStartGrp) { ?>
	<td><img src="phprptimages/lastdisab.gif" alt="fundit" width="16" height="16" border="0"></td>
	<?php } else { ?>
	<td><a href="skadencarpt.php?start=<?php echo $LastStart; ?>"><img src="phprptimages/last.gif" alt="fundit" width="16" height="16" border="0"></a></td>
	<?php } ?>
