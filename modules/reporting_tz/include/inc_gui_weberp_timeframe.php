	                        ...
	                        <label><?php echo 'Transaction'; ?>
	                        <select name="transaction">

	                        <?php

	                        if($_REQUEST[transaction] == 'saleInvoice'){
	                       		echo'<option value="saleInvoice" selected> Sale Invoice </option><option value="debtor">Debtor</option>';
	                        }else if($_REQUEST[transaction] == 'debtor') {
								echo'<option value="saleInvoice"> Sale Invoice </option><option value="debtor" selected>Debtor</option>';
	                        }
	                        else {
	                        	echo'<option value="saleInvoice" > Sale Invoice </option><option value="debtor">Debtor</option>';
