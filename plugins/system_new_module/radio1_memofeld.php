...
<textarea onmouseover="this.style.backgroundColor='#ffff00'; this.style.color='#0000ff' "  onmouseout="this.style.backgroundColor='#ffff99'; this.style.color='#000000' "  style="background:ffff99" name="sqlstring" cols="83" rows="10" ><?php echo $sql_code;?></textarea><br/><br/><br/>

<input type='text' name="tab_name" value="<?php echo $ModulNeuBez; ?>">
