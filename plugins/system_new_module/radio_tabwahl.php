...
<li>
	...
	<input type='text'   name="tab_name" value="<?php echo $ModulNeuBez; ?>"><!-- style="text-align:right" -->
  ...
  <input type='text'   name="host" value="localhost">
      ...
      <input type="hidden" name="ModulNeuBez" value="<?php echo $ModulNeuBez; ?>"><br/>
...
<?php$radio1_file=$root_path.$top_dir."radio1_memofeld.php?sid=".$sid."&lang=".$lang."&pid=".$pid."&ModulNeuBez=".$ModulNeuBez."&pid=".$pid."&pat_bez=".$pat_bez;
